...
export default class ViewScreen extends Component {
  ...
  componentDidMount() {
    let query = studentsRef.orderByChild("rnumber").equalTo(this.props.rnumber);
    ...
    if(this.state.name && this.state.rnumber && this.state.major && this.state.year && this.state.status){
      if(isNaN(this.state.rnumber)){
        Alert.alert('Status','Invalid R number!');
         ...
         updateStudent(this.state.name, this.state.rnumber, this.state.major, this.state.year, this.state.status);
       }
    } else{
    ...
    return (
      <Container>
        ...
        <Item fixedLabel last>
              ...
              <Input onChangeText={this.setrnumber} value={this.state.rnumber} disabled={true} />
        </Item>
